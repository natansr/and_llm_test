...
├── ground_truth/
│   └── Koichi Furukawa.xml                # Ground truth labels in XML format        
├── analysis/
...
- **DeepSeek-R1-Distill-Llama-8B** provided a split of publications, often clustering documents broadly without clear justification.
